...
public interface PrinterPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default String printUpperCase(String s)
    {
        return printUpperCase(s, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default String printUpperCase(String s, java.util.Map<String, String> context)
    {
        return _iceI_printUpperCaseAsync(s, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> printUpperCaseAsync(String s)
    {
        return _iceI_printUpperCaseAsync(s, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> printUpperCaseAsync(String s, java.util.Map<String, String> context)
    {
        return _iceI_printUpperCaseAsync(s, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.String> _iceI_printUpperCaseAsync(String iceP_s, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.String> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "printUpperCase", null, sync, null);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeString(iceP_s);
                 }, istr -> {
                     String ret;
