...
public interface CalculatorPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default java.util.concurrent.CompletableFuture<java.lang.Integer> somaAsync(int a, int b)
    {
        return _iceI_somaAsync(a, b, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Integer> somaAsync(int a, int b, java.util.Map<String, String> context)
    {
        return _iceI_somaAsync(a, b, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Integer> _iceI_somaAsync(int iceP_a, int iceP_b, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Integer> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "soma", null, sync, null);
    ...
    {
        return subtrair(a, b, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default int subtrair(int a, int b, java.util.Map<String, String> context)
    {
        return _iceI_subtrairAsync(a, b, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.Integer> subtrairAsync(int a, int b)
    {
        return _iceI_subtrairAsync(a, b, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Integer> subtrairAsync(int a, int b, java.util.Map<String, String> context)
    {
        return _iceI_subtrairAsync(a, b, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Integer> _iceI_subtrairAsync(int iceP_a, int iceP_b, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Integer> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "subtrair", null, sync, null);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeInt(iceP_a);
                     ostr.writeInt(iceP_b);
                 }, istr -> {
    ...
    {
        return multiplicar(a, b, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default int multiplicar(int a, int b, java.util.Map<String, String> context)
    {
        return _iceI_multiplicarAsync(a, b, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.Integer> multiplicarAsync(int a, int b)
    {
        return _iceI_multiplicarAsync(a, b, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Integer> multiplicarAsync(int a, int b, java.util.Map<String, String> context)
    {
        return _iceI_multiplicarAsync(a, b, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Integer> _iceI_multiplicarAsync(int iceP_a, int iceP_b, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Integer> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "multiplicar", null, sync, null);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeInt(iceP_a);
                     ostr.writeInt(iceP_b);
                 }, istr -> {
